...
<head>
  ...
  <title>CherryPy Tutorials &mdash; T-Vecs 1 documentation</title>
...
<div role="navigation" aria-label="breadcrumbs navigation">
  ...
  <ul class="wy-breadcrumbs">
      ...
      <li>CherryPy Tutorials</li>
    
    
      <li class="wy-breadcrumbs-aside">
        
            
            <a href="../../../../../../_sources/venv/lib64/python3.6/site-packages/cherrypy/tutorial/README.rst.txt" rel="nofollow"> View page source</a>
  ...
  <div class="section" id="cherrypy-tutorials">
<h1>CherryPy Tutorials<a class="headerlink" href="#cherrypy-tutorials" title="Permalink to this headline">¶</a></h1>
<p>This is a series of tutorials explaining how to develop dynamic web
applications using CherryPy. A couple of notes:</p>
<ul class="simple">
<li><p>Each of these tutorials builds on the ones before it. If you’re
new to CherryPy, we recommend you start with 01_helloworld.py and
work your way upwards. :)</p></li>
<li><p>In most of these tutorials, you will notice that all output is done
...
CherryTemplate or XML/XSL).</p></li>
</ul>
</div>
