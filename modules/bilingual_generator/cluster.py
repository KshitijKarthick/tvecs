...
def build_clusters(entire_word_list, model, damping_factor=0.5):
    """
    Cluster word_list using Affinity Propagation based on the vectors from the model.

    API Documentation:
        :param entire_word_list: Word List provided to cluster.
        :param model: Model file passed to obtain the vectors for the words from word_list.
