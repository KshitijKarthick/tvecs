...
def extract_correlation_coefficient(score_data_path):
    """Extract Human Score, Calculated Score from score file."""
    with codecs.open(score_data_path, 'r', encoding='utf-8') as file:
        ...
        return get_correlation_coefficient(human_score, calculated_score)
