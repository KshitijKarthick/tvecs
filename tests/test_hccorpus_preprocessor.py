...
.. py:currentmodule:: tvecs.preprocessor.hccorpus_preprocessor
"""
...
class TestHcCorpusPreprocessor:
    ...
    Test Cases considered for the following functions
        - :func:`HcCorpusPreprocessor._extract_corpus_data`
        - :func:`HcCorpusPreprocessor._clean_word`
        - :func:`HcCorpusPreprocessor._tokenize_sentences`
        - :func:`HcCorpusPreprocessor._tokenize_words`
    ...
    def setup_class(cls):
        """
        Setup Unit Testing for :class:`HcCorpusPreprocessor`.
        ...
        |                 Tests :class:`HcCorpusPreprocessor`.
        |
        ...
        |
        | *Expected Result* : Instance of :class:`HcCorpusPreprocessor` created
        |
        | *Actual Result* : Instance of :class:`HcCorpusPreprocessor` created
        |
        | **Status : Pass**
        |
    ...
    def teardown_class(cls):
        ...
        |                 test_hccorpus_corpus_processed to remove file.
        |
        | *Preconditions* : Preprocessed test_hccorpus_corpus_processed
        ...
        |                     test_hccorpus_corpus_processed is deleted.
        |
        ...
        try:
            os.remove(
                os.path.join(
                    'tests',
                    'resources',
                    'test_hccorpus_corpus.%s' % 'preprocessed'
                )
            )
    ...
    def test_implement_extract_corpus_data(self):
        ...
        |                 :func:`HcCorpusPreprocessor._extract_corpus_data`.
        |
        | *Preconditions* : :class:`HcCorpusPreprocessor` instance exists.
        |
    ...
    def test_implement_clean_word(self):
        ...
        |                 is implemented in the class.
        |                 Tests :func:`HcCorpusPreprocessor._clean_word`.
        |
        | *Preconditions* : :class:`HcCorpusPreprocessor` instance exists.
        |
    ...
    def test_implement_tokenize_sentences(self):
        ...
        |                 is implemented in the class.
        |                 Test :func:`HcCorpusPreprocessor._tokenize_sentences`
        |
        | *Preconditions* : HcCorpusPreprocessor class instance exists.
        |
        | *Test Parameters* : data passed to function.
        |
        | *Test Data* : data=''
    ...
    def test_implement_tokenize_words(self):
        ...
        |                 is implemented in the class.
        |                 Tests :func:`HcCorpusPreprocessor._tokenize_words`.
        |
        | *Preconditions* : :class:`HcCorpusPreprocessor` class instance exists
        |
    ...
    def test_extract_corpus_data(self):
        ...
        | *Test Parameters* : data passed to function.
        |
        | *Test Data* : data = 'blogspot.com\t2011/10/01\t3\t0\t' \
    ...
    def test_english_tokenize_sentences(self):
        ...
        |                 Test :func:`HcCorpusPreprocessor._tokenize_sentences`
        |
        | *Preconditions* : :class:`HcCorpusPreprocessor` instance must exist.
        |
